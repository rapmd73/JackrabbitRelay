...
This module records the balances of all your accounts for statistical
analysis.
...
You can run it more frequently then once a day, but its really not
beneficial.

```crontab
0 3 * * * /home/JackrabbitRelay/Extras/Statistics/GetExchangeBalances > /dev/null 2>&1
```

## Testing

Run the below of the command line. There will be no output, buy the
results will be in the `/home/JackrabbitRelay/Statistics/Balances` folder.
