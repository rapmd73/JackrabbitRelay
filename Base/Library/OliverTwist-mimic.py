...
#            print("PO C")
        ...
        relay.JRLog.Write(f"CONDmimic PO {id}: {sys.exc_info()[-1].tb_lineno}/{str(e)}")
        return False
...
#            if abs(bal)>abs(amount):
        ...
        # Something broke or went horrible wrong
        relay.JRLog.Write(f"CONDmimic CheckTakeProfit {id}: {sys.exc_info()[-1].tb_lineno}/{str(e)}")
    return None
...
#        print("CSL E")
        ...
        # Something broke or went horrible wrong
        relay.JRLog.Write(f"CONDmimic CheckStopLoss {id}: {sys.exc_info()[-1].tb_lineno}/{str(e)}")
    return None
...
#        print("OP A",asset,highestTrade['Price'],lowestTrade['Price'])
...
#        print("OP C")
        ...
        #
        # NO limit/orphan orders in MIMIC.
